...
import fr.initiativedeuxsevres.ttm.model.Role;
import fr.initiativedeuxsevres.ttm.configuration.JwtAuthenticationFilter;
...
public class ConfigSpringSecurity {
    ...
    @Autowired
    public ConfigSpringSecurity(PasswordEncoder passwordEncoder, UserDetailsService userDetailsService, JwtAuthenticationFilter jwtAuthenticationFilter) {
        this.passwordEncoder = passwordEncoder;
        this.userDetailsService = userDetailsService;

...
const TextAccueil = () => {
    return (
        <div>
            <p>Trouve ton match est une appli qui vous permettra de trouver <strong>LA</strong> </p>
            <p>personne pour vous accompagner et vous soutenir,</p>
            <p>une épaule sur laquelle vous reposer.</p> 
            <br/>
            <p>Le but étant de créer un climat de confiance avec cette </p>
